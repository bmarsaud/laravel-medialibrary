...
class UpdateManipulationsTest extends \Spatie\MediaLibrary\Tests\TestCase
{
    /** @test */
    public function it_will_create_derived_files_when_manipulations_have_changed()
    {
        $testModelClass = new class extends \Spatie\MediaLibrary\Tests\TestSupport\TestModels\TestModel
        {
        ...
        $media->manipulations = ['update_test' => ['width' => 1, 'height' => 1]];
        $media->save();
