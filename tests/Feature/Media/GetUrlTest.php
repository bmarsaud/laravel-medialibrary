...
class GetUrlTest extends \Spatie\MediaLibrary\Tests\TestCase
{
    /** @test */
    ...
    {
        $media = $this->testModel->addMedia($this->getTestJpg())->toMediaCollection();
        $this->expectException(\Spatie\MediaLibrary\MediaCollections\Exceptions\InvalidConversion::class);
